...
export async function generateMetadata({
    ...
    return {
        title: 'Стать мастером — Svoi.de',
        description: 'Зарегистрируйтесь как мастер на Svoi.de и принимайте онлайн-записи без комиссии.',
        alternates: localizedAlternates(resolveLocale(params.locale), '/become-pro'),
    };
}
