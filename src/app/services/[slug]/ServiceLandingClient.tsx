...
export default function ServiceLandingClient({ serviceName }: Props) {
    ...
    const handleSearch = (e: React.FormEvent) => {
        ...
        if (!locationQuery.trim()) {
            ...
            toast.error("Пожалуйста, укажите город для поиска мастера");
            ...
            <section className="w-full max-w-4xl px-6 md:px-12 text-center pt-16 md:pt-24 pb-12">
                ...
                >
                    ...
                    <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto font-light leading-relaxed">
                        Бронирование премиальных бьюти-специалистов. Гарантия качества и строгий аудит каждого мастера SVOI.
                    </p>
                </motion.div>
            </section>
