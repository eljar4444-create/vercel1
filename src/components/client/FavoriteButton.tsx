...
export function FavoriteButton({
    ...
    const t = useTranslations('forms.favorite');
    ...
    const handleClick = (e: React.MouseEvent) => {
        ...
        startTransition(async () => {
            ...
            if (result.isFavorited) toast.success(t('added'));
            else {
    ...
    if (variant === 'list') {
        return (
            <button
                ...
                onClick={handleClick}
                disabled={isPending}
                aria-label={optimisticFavorited ? t('removeAria') : t('addAria')}
    ...
    return (
        <button
            ...
            onClick={handleClick}
            disabled={isPending}
            aria-label={optimisticFavorited ? t('removeAria') : t('shortAddAria')}
